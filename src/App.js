...
function App() {
  ...
  return (
    <div className="App" style={{backgroundImage:`url(https://www.shutterstock.com/image-photo/man-hand-open-empty-leather-600nw-1924813010.jpg)`, backgroundPosition:"center", backgroundRepeat:"no-repeat"}}>
