  ...
  return (
    <div className="CardCont">
      ...
      <div className="leftInfo">
        ...
        <p className="price"> <b style={{borderBottom:" solid 2px orange", padding:"1px 5px"}}>{product.txtPrecio1}</b>   ${product.price}</p>
        {product.txtPrecio2?<p className="price"><b style={{borderBottom:" solid 2px orange", padding:"1px 3px"}}>{product.txtPrecio2}</b>  ${product.price2}</p>:null}
